...
- (void)navigationController:(UINavigationController *)navigationController didShowViewController:(UIViewController *)viewController animated:(BOOL)animated{
    if (self.childViewControllers.count > 1) {
        ...
        if ([viewController isKindOfClass:NSClassFromString(@"MainViewController")] ||[viewController isKindOfClass:NSClassFromString(@"SettingViewController")] || [viewController isKindOfClass:NSClassFromString(@"AddressBookViewController")]) {
